...
export default function Alojamiento() {
  ...
  return (
    <div>
      {/* Hero limpio */}
      <HeroSection
        titulo="Encuentra alojamiento para tu mascota"
        descripcion="Busca hospedajes pet-friendly, seguros y con atención dedicada para tu compañero."
...
export const PageInfo = {
    path: "alojamiento",
    title: "Alojamiento",
    homeStats: "Ofrece tu hospedaje",
    logo: "/logos/hotel.svg",
